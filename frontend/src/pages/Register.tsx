...
import { UserPlus, Loader, Timer } from 'lucide-react';
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="mt-10 text-center mb-8">
          ...
          <p className="text-gray-400 text-sm animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Join the Rally Racing Community
          </p>
        </div>
        ...
        <div className="bg-gradient-to-b from-gray-900 to-black rounded-2xl shadow-2xl p-8 border border-gray-800 backdrop-blur-xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <div className="space-y-2 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <label htmlFor="email" className="block text-xs font-black text-gray-400 uppercase tracking-widest flex items-center space-x-2">
                <span className="w-1 h-4 bg-rally-red animate-pulse"></span>
                <span>Pit Crew Email</span>
              </label>
              <div className="relative group">
                <input
                  type="email"
                  ...
                  required
                  className="w-full bg-black/50 border-2 border-gray-800 focus:border-rally-red text-white px-4 py-3.5 rounded-lg transition-all duration-300 focus:ring-2 focus:ring-rally-red/20 placeholder-gray-600 font-medium group-hover:border-gray-700"
                  placeholder="Your pit crew email"
                  disabled={loading}
                />
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                  <div className="w-2 h-2 bg-rally-amber rounded-full animate-pulse"></div>
            ...
            <div className="space-y-2 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="relative group">
                <input
                  ...
                  minLength={6}
                  className="w-full bg-black/50 border-2 border-gray-800 focus:border-rally-red text-white px-4 py-3.5 rounded-lg transition-all duration-300 focus:ring-2 focus:ring-rally-red/20 placeholder-gray-600 font-medium group-hover:border-gray-700"
                  placeholder="Create your pit pass"
                  disabled={loading}
                />
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
              ...
              <p className="text-xs text-gray-500 flex items-center gap-1 ml-1 animate-fade-in">
            ...
            <div className="space-y-2 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <label htmlFor="confirmPassword" className="block text-xs font-black text-gray-400 uppercase tracking-widest flex items-center space-x-2">
                <span className="w-1 h-4 bg-rally-red animate-pulse"></span>
              ...
              <div className="relative group">
                <input
                  ...
                  required
                  className="w-full bg-black/50 border-2 border-gray-800 focus:border-rally-red text-white px-4 py-3.5 rounded-lg transition-all duration-300 focus:ring-2 focus:ring-rally-red/20 placeholder-gray-600 font-medium group-hover:border-gray-700"
                  placeholder="Confirm your pit pass"
                  disabled={loading}
                />
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                  <svg className="w-5 h-5 text-gray-600 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              {loading ? (
                ...
                <span className="flex items-center justify-center space-x-3 relative z-10">
                  <UserPlus className="w-5 h-5 animate-bounce" style={{ animationDelay: '0.5s' }} />
          ...
          <div className="mt-8 text-center animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <p className="text-gray-400 text-sm">
              ...
              <Link to="/login" className="text-rally-amber hover:text-rally-red font-bold transition-colors inline-flex items-center group animate-pulse">
                Start Your Engine
          ...
          <div className="mt-6 flex items-center justify-center space-x-6 text-gray-700 text-xs animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
